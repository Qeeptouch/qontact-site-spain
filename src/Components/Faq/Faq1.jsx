...
const Faq1 = () => {
    ...
    const FaqContent = {
        Content:'Sabemos que al momento de implementar un nuevo sistema pueden surgir dudas. Por eso, armamos esta sección con las consultas más comunes sobre Qontact: cómo funciona, cómo se configura y cómo puede ayudarte a gestionar la asistencia de tu equipo de forma simple, rápida y sin complicaciones.',
